/* Глобальные функции инициализации */
    function initMain(char, image, item1, item2, item3, item4, item5, item6) {
        ...
        imgThis = image;
        // Вывод статов
        var stats = "<div class='row main'><div class='span3'><h4 class='center'>Статы на 18 уровне: </h4><p class='center'>(без учета бонусов)</p>" +
        ...
        var n = 1;
        for (var i = 2; i < 8; i++) {
            var locItem = $(image).attr('id') + 'Item' + n;
    ...
    function initSkills(spell1, spell2, skill1, skill2, skill3, skill4, skill5, skill6, skill7, skill8, skill9, skill10, skill11, skill12, skill13, skill14, skill15, skill16, skill17, skill18) {
        var n = 1;
        for (var i = 0; i < 2; i++) {
            var locSpell = $(imgThis).attr('id') + 'Spell' + n;
        ...
        var x = 1;
        for (var m = 2; m < 20; m++) {
            var locSkill = $(imgThis).attr('id') + 'Skill' + x;
    ...
    function initRunes(one, two, three, four) {
        var n = 1;
        for (var i = 0; i < 4; i++) {
            var locRune = $(imgThis).attr('id') + 'Rune' + n;
